...
func main() {
	...
	// A rune is a Unicode code point which is one to four bytes
	// Because of this rune is a type of int32 - four bytes is 32 (4*8) bits
	// And a string is made up of a bunch of runes or characters
}
